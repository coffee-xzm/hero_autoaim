...
class Armor(metaclass=Metaclass_Armor):
    ...
    _fields_and_field_types = {
        ...
        'y_coordinate_in_camera_frame': 'float',
        'pose': 'geometry_msgs/Pose',
        'base_link_pose': 'geometry_msgs/Pose',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.y_coordinate_in_camera_frame = kwargs.get('y_coordinate_in_camera_frame', float())
        from geometry_msgs.msg import Pose
        self.pose = kwargs.get('pose', Pose())
        from geometry_msgs.msg import Pose
        self.base_link_pose = kwargs.get('base_link_pose', Pose())
    ...
    def __eq__(self, other):
        ...
        if self.distance_to_image_center != other.distance_to_image_center:
            return False
        if self.y_coordinate_in_camera_frame != other.y_coordinate_in_camera_frame:
            return False
        if self.pose != other.pose:
            return False
        if self.base_link_pose != other.base_link_pose:
            return False
        return True
    ...
    @builtins.property
    def y_coordinate_in_camera_frame(self):
        """Message field 'y_coordinate_in_camera_frame'."""
        return self._y_coordinate_in_camera_frame

    @y_coordinate_in_camera_frame.setter
    def y_coordinate_in_camera_frame(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'y_coordinate_in_camera_frame' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'y_coordinate_in_camera_frame' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._y_coordinate_in_camera_frame = value
    ...
    @builtins.property
    def base_link_pose(self):
        """Message field 'base_link_pose'."""
        return self._base_link_pose

    @base_link_pose.setter
    def base_link_pose(self, value):
        if __debug__:
            from geometry_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'base_link_pose' field must be a sub message of type 'Pose'"
        self._base_link_pose = value
