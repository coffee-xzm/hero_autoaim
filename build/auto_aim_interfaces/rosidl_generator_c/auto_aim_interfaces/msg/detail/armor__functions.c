...
auto_aim_interfaces__msg__Armor__init(auto_aim_interfaces__msg__Armor * msg)
{
  ...
  // base_link_pose
  if (!geometry_msgs__msg__Pose__init(&msg->base_link_pose)) {
    auto_aim_interfaces__msg__Armor__fini(msg);
    return false;
  }
  return true;
...
auto_aim_interfaces__msg__Armor__fini(auto_aim_interfaces__msg__Armor * msg)
{
  ...
  // base_link_pose
  geometry_msgs__msg__Pose__fini(&msg->base_link_pose);
}
...
auto_aim_interfaces__msg__Armor__are_equal(const auto_aim_interfaces__msg__Armor * lhs, const auto_aim_interfaces__msg__Armor * rhs)
{
  ...
  // y_coordinate_in_camera_frame
  if (lhs->y_coordinate_in_camera_frame != rhs->y_coordinate_in_camera_frame) {
    return false;
  }
  // pose
  ...
  // base_link_pose
  if (!geometry_msgs__msg__Pose__are_equal(
      &(lhs->base_link_pose), &(rhs->base_link_pose)))
  {
    return false;
  }
  return true;
  ...
  auto_aim_interfaces__msg__Armor * output)
{
  ...
  // y_coordinate_in_camera_frame
  output->y_coordinate_in_camera_frame = input->y_coordinate_in_camera_frame;
  // pose
  ...
  // base_link_pose
  if (!geometry_msgs__msg__Pose__copy(
      &(input->base_link_pose), &(output->base_link_pose)))
  {
    return false;
  }
  return true;
