...
class Init_Armor_base_link_pose
{
public:
  explicit Init_Armor_base_link_pose(::auto_aim_interfaces::msg::Armor & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Armor base_link_pose(::auto_aim_interfaces::msg::Armor::_base_link_pose_type arg)
  {
    msg_.base_link_pose = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armor_base_link_pose pose(::auto_aim_interfaces::msg::Armor::_pose_type arg)
  {
    msg_.pose = std::move(arg);
    return Init_Armor_base_link_pose(msg_);
  }
...
class Init_Armor_y_coordinate_in_camera_frame
{
public:
  explicit Init_Armor_y_coordinate_in_camera_frame(::auto_aim_interfaces::msg::Armor & msg)
  : msg_(msg)
  {}
  Init_Armor_pose y_coordinate_in_camera_frame(::auto_aim_interfaces::msg::Armor::_y_coordinate_in_camera_frame_type arg)
  {
    msg_.y_coordinate_in_camera_frame = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armor_y_coordinate_in_camera_frame distance_to_image_center(::auto_aim_interfaces::msg::Armor::_distance_to_image_center_type arg)
  {
    msg_.distance_to_image_center = std::move(arg);
    return Init_Armor_y_coordinate_in_camera_frame(msg_);
  }
