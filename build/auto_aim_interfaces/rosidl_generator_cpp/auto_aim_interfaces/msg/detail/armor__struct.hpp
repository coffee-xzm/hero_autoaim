...
struct Armor_
{
    ...
    base_link_pose(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->y_coordinate_in_camera_frame = 0.0f;
    }
  }
  ...
  using _y_coordinate_in_camera_frame_type =
    float;
  _y_coordinate_in_camera_frame_type y_coordinate_in_camera_frame;
  using _pose_type =
    geometry_msgs::msg::Pose_<ContainerAllocator>;
  _pose_type pose;
  using _base_link_pose_type =
    geometry_msgs::msg::Pose_<ContainerAllocator>;
  ...
  Type & set__y_coordinate_in_camera_frame(
    const float & _arg)
  {
    this->y_coordinate_in_camera_frame = _arg;
    return *this;
  }
  Type & set__pose(
  ...
  Type & set__base_link_pose(
    const geometry_msgs::msg::Pose_<ContainerAllocator> & _arg)
  {
    this->base_link_pose = _arg;
    return *this;
  }
  ...
  bool operator==(const Armor_ & other) const
  {
    ...
    if (this->y_coordinate_in_camera_frame != other.y_coordinate_in_camera_frame) {
      return false;
    }
    if (this->pose != other.pose) {
      return false;
    }
    if (this->base_link_pose != other.base_link_pose) {
      return false;
    }
    return true;
  }
