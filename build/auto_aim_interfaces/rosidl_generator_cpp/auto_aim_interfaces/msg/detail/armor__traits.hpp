  ...
  std::ostream & out)
{
  ...
  {
    out << "y_coordinate_in_camera_frame: ";
    rosidl_generator_traits::value_to_yaml(msg.y_coordinate_in_camera_frame, out);
    out << ", ";
  }
  ...
  {
    out << "base_link_pose: ";
    to_flow_style_yaml(msg.base_link_pose, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: base_link_pose
  {
    ...
    out << "base_link_pose:\n";
    to_block_style_yaml(msg.base_link_pose, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
