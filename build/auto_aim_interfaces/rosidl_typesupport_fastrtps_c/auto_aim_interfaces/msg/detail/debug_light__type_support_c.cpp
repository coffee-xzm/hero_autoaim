  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: top_x
  {
    cdr << ros_message->top_x;
  }

  // Field name: top_y
  {
    cdr << ros_message->top_y;
  }

  // Field name: bottom_x
  {
    cdr << ros_message->bottom_x;
  }

  // Field name: bottom_y
  {
    cdr << ros_message->bottom_y;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name top_x
  {
    size_t item_size = sizeof(ros_message->top_x);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name top_y
  {
    size_t item_size = sizeof(ros_message->top_y);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bottom_x
  {
    size_t item_size = sizeof(ros_message->bottom_x);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name bottom_y
  {
    size_t item_size = sizeof(ros_message->bottom_y);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
