...
#include "geometry_msgs/msg/detail/pose__functions.h"  // base_link_pose, pose
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: y_coordinate_in_camera_frame
  {
    cdr << ros_message->y_coordinate_in_camera_frame;
  }
  ...
  // Field name: base_link_pose
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->base_link_pose, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: base_link_pose
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->base_link_pose))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name y_coordinate_in_camera_frame
  {
    size_t item_size = sizeof(ros_message->y_coordinate_in_camera_frame);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pose
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Pose(
    &(ros_message->base_link_pose), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // member: y_coordinate_in_camera_frame
  {
    size_t array_size = 1;
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, base_link_pose) +
      last_member_size
      ) == ret_val;
  }
