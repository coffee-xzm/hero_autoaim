...
private:
  ...
  double original_s2qyaw_;  // Original sigma2_q_yaw value for recovery
  double r_xyz_factor, r_yaw;
  double lost_time_thres_;
  bool adaptive_yaw_tuning_;  // Enable/disable adaptive yaw parameter tuning
  double yaw_error_threshold_;  // Threshold (rad) for triggering parameter adjustment
