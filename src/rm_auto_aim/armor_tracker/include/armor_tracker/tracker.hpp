...
public:
  // Setters for adaptive yaw tuning parameters
  void setAdaptiveYawTuning(bool enable) { adaptive_yaw_tuning_ = enable; }
  void setYawErrorThreshold(double threshold) { yaw_error_threshold_ = threshold; }
  void setOriginalS2QYaw(double value) { original_s2qyaw_ = value; }
};
