...
public:
  ...
  bool light_modifybycolor;

  Detector(const int & bin_thres, const int & color, const LightParams & l, const ArmorParams & a, const bool & modifybycolor);
