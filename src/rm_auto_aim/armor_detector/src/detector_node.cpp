...
{
  auto light_modifybycolor = this->declare_parameter<bool>("light_modifybycolor", false);
  ...
  auto detector = std::make_unique<Detector>(binary_thres, detect_color, l_params, a_params, light_modifybycolor);
  ...
  const sensor_msgs::msg::Image::ConstSharedPtr & img_msg)
{
  ...
  if (debug_) {
    ...
    // Light corner info is already filled in detector
