...
{
Detector::Detector(
  const int & bin_thres, const int & color, const LightParams & l, const ArmorParams & a, const bool & modifybycolor)
: light_modifybycolor(modifybycolor), binary_thres(bin_thres), detect_color(color), l(l), a(a)
{
}
